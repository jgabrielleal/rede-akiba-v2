export default function ImagemEmDestaque() {
    return (
        <>
            ...
            <label htmlFor="imagemEmDestaque" className="w-full h-56 bg-aurora rounded-md flex justify-center items-center text-azul-claro text-6xl font-averta font-bold">
                +
            </label>
